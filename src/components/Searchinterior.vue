...
export default {
  ...
  methods: {
    carMat: function () {
      $.ajax({
        url: 'http://zscg.enderqiu.cn/api/interior/search?Type=座垫',
        type: 'GET',
    ...
    carPendant: function () {
      $.ajax({
        url: 'http://zscg.enderqiu.cn/api/interior/search?Type=汽车挂件',
        type: 'GET',
    ...
    wheelCover: function () {
      $.ajax({
        url: 'http://zscg.enderqiu.cn/api/interior/search?Type=方向盘套',
        type: 'GET',
    ...
    others: function () {
      $.ajax({
        url: 'http://zscg.enderqiu.cn/api/interior/search?Type=其他',
        type: 'GET',

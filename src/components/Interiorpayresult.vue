...
<div class="interiorpayresult">
  ...
  <div id="border">
      ...
      <div id="pic">
        <div id="circle">
                <span class="glyphicon glyphicon-ok"
                      style="font-size: 40px;color: red;margin-top: 10px;margin-left: 10px"></span>
        </div>
      </div>
      <div id="tip">
        <p>付款成功</p>
    ...
    <div id="bottom">
      <div id="submit">
        <button class="btn btn-default myBtn"><a href="#/interiorhandle">查看订单</a></button>
      </div>
      <div id="words">

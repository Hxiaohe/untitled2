...
export default {
  ...
  methods: {
    get5wdowm: function () {
      $.ajax({
        url: 'http://zscg.enderqiu.cn/api/car/shelf?lPrice=1&hPrice=50000',
        type: 'GET',
    ...
    get5to8: function () {
      $.ajax({
        url: 'http://zscg.enderqiu.cn/api/car/shelf?lPrice=50000&hPrice=80000',
        type: 'GET',
    ...
    get10to15: function () {
      $.ajax({
        url: 'http://zscg.enderqiu.cn/api/car/shelf?lPrice=100000&hPrice=150000',
        type: 'GET',
    ...
    getSUV: function () {
      $.ajax({
        url: 'http://zscg.enderqiu.cn/api/car/shelf?grade=SUV&lPrice=1&hPrice=10000000',
        type: 'GET',
    ...
    getjc: function () {
      $.ajax({
        url: 'http://zscg.enderqiu.cn/api/car/shelf?grade=紧凑型&lPrice=1&hPrice=10000000',
        type: 'GET',
    ...
    getzd: function () {
      $.ajax({
        url: 'http://zscg.enderqiu.cn/api/car/shelf?gearbox=自动&lPrice=1&hPrice=10000000',
        type: 'GET',
    ...
    getcarlist: function () {
      ...
      //   dataType: 'json',
      //
      //   url: 'http://zscg.enderqiu.cn/api/api/car/search?brand=劳斯莱斯&lPrice=10.0&hPrice=700.0',
      //   cache: true,
      //   success: (data) => {
      ...
      // })
      $.ajax({
        url: 'http://zscg.enderqiu.cn/api/car/shelf',
        type: 'GET',

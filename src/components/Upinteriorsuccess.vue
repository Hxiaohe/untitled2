<template>
  <div class="upinteriorsuccess">
    <link rel="stylesheet" href="static/CSS/upnewresult.css">
    <meta name="renderer" content="webkit">
    <br>
    <br>

    <img  v-bind:src="this.$store.state.interiorlist['interiorImageUrl']" alt="商品图片"/>
    ...
    <form class="info" role="form" action="">
      <div class="form-group" id="button">
        <button type="submit" class="btn btn-default" onclick="javascript:window.location.href='#/interiordetail?index=0';">查看详情</button>
        <br>
        <br>
      </div>
    </form>
